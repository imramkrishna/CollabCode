      ...
      >
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-6 gap-8">
          ...
          <motion.div className="lg:col-span-2" variants={itemVariants}>
            <div className="flex items-center space-x-2 mb-4">
              <div className="w-8 h-8 bg-gradient-to-r from-teal-600 to-teal-400 rounded-lg flex items-center justify-center">
                <span className="text-black font-bold text-sm">CC</span>
              </div>
              <span className="text-white font-bold text-xl">CollabCode</span>
            </div>
            <p className="text-gray-400 text-sm mb-6 max-w-sm">
              Empower your team with real-time collaborative coding. Write, edit, and debug together, 
              wherever you are.
            </p>
        ...
        >
          <div className="grid grid-cols-1 md:grid-cols-2 gap-8 items-center">
            ...
            <div className="flex flex-col sm:flex-row gap-3">
              ...
              />
              <motion.button
                className="px-6 py-2 bg-gradient-to-r from-teal-600 to-teal-400 text-black rounded-lg font-medium hover:from-teal-700 hover:to-teal-500 transition-all duration-200 whitespace-nowrap"
        ...
        >
          ...
          <div className="flex space-x-6 mt-4 sm:mt-0">
            ...
            <a href="#cookies" className="text-gray-400 hover:text-teal-400 text-sm transition-colors duration-200">
              Cookies
            </a>
          </div>
        </motion.div>
